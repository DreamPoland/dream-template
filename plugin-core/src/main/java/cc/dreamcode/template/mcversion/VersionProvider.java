...
import cc.dreamcode.template.mcversion.v1_20_R2.V1_20_R2_VersionAccessor;
import cc.dreamcode.template.mcversion.v1_20_R3.V1_20_R3_VersionAccessor;
...
public class VersionProvider {
    public static VersionAccessor getVersionAccessor() {
        switch (ReflectionUtils.NMS_VERSION) {
            ...
            case "v1_20_R2": {
                return new V1_20_R2_VersionAccessor();
            }
            case "v1_20_R3": {
                return new V1_20_R3_VersionAccessor();
            }
            default: {
                throw new RuntimeException("Plugin doesn't support this server version, update to: 1.8.8, 1.12.2, 1.16.5, 1.17.1, 1.18.2, 1.19.3, 1.19.4, 1.20.+");
            }
        }
    }
}
