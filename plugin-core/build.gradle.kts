...
dependencies {
    ...
    // -- dream-platform --
    implementation("cc.dreamcode.platform:core:1.11.9")
    implementation("cc.dreamcode.platform:bukkit:1.11.9")
    implementation("cc.dreamcode.platform:bukkit-config:1.11.9")
    implementation("cc.dreamcode.platform:dream-command:1.11.9")
    implementation("cc.dreamcode.platform:persistence:1.11.9")
