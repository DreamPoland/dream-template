...
dependencies {
    ...
    implementation("cc.dreamcode.platform:bukkit-config:1.9.18")
    implementation("cc.dreamcode.platform:persistence:1.9.18")
    ...
    // -- dream-notice --
    implementation("cc.dreamcode.notice:core:1.4.6")
    implementation("cc.dreamcode.notice:minecraft:1.4.6")
    implementation("cc.dreamcode.notice:minecraft-adventure:1.4.6")
    implementation("cc.dreamcode.notice:bukkit-adventure:1.4.6")
    implementation("cc.dreamcode.notice:bukkit-adventure-serializer:1.4.6")
