...
dependencies {
    ...
    // -- dream-platform --
    implementation("cc.dreamcode.platform:core:1.11.12")
    implementation("cc.dreamcode.platform:bukkit:1.11.12")
    implementation("cc.dreamcode.platform:bukkit-config:1.11.12")
    implementation("cc.dreamcode.platform:dream-command:1.11.12")
    implementation("cc.dreamcode.platform:persistence:1.11.12")
    ...
    // -- dream-command --
    implementation("cc.dreamcode.command:core:2.0.7")
    implementation("cc.dreamcode.command:bukkit:2.0.7")
