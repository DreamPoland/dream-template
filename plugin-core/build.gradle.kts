...
dependencies {
    ...
    // -- dream-platform --
    implementation("cc.dreamcode.platform:core:1.11.13")
    implementation("cc.dreamcode.platform:bukkit:1.11.13")
    implementation("cc.dreamcode.platform:bukkit-config:1.11.13")
    implementation("cc.dreamcode.platform:dream-command:1.11.13")
    implementation("cc.dreamcode.platform:persistence:1.11.13")
    ...
    // -- dream-command --
    implementation("cc.dreamcode.command:core:2.0.8")
    implementation("cc.dreamcode.command:bukkit:2.0.8")
