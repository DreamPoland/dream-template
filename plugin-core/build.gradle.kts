...
dependencies {
    ...
    implementation("cc.dreamcode.platform:bukkit:1.11.11")
    implementation("cc.dreamcode.platform:bukkit-config:1.11.11")
    implementation("cc.dreamcode.platform:dream-command:1.11.11")
    implementation("cc.dreamcode.platform:persistence:1.11.11")
    ...
    implementation("cc.dreamcode.command:bukkit:2.0.6")
